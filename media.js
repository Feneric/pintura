...
exports.makeForEachable = function(input){
	if (typeof input === 'object' && input instanceof Array){
		// It's already forEachable; return it as-is.
		return input;
	}else{
		// Here's our main target use.
		// If it's an object, first convert it to a string.
		// Split the string up by lines but otherwise undo the data
		// alteration by split(). It's not quite perfect; if the
		// original input doesn't end with a carriage return, the
		// output will.
